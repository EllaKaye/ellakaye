...
author: "Ella Kaye"
date: "Birmingham R User Group, August 23rd 2018"
output:
...
#duo_accent(primary_color = "#009E73", 
#           secondary_color = "#F0E442",
#           code_font_family = "Fira Code",
#           code_font_url    = "https://cdn.rawgit.com/tonsky/FiraCode/1.204/distr/fira_code.css")
```
...
- Use the latest version of RStudio (1.1.456 or higher)
...
- Make an 'analysis' folder (can use Terminal in RStudio)
